...
function show() {
    ...
    /* this teels the browser how to display the todo array after an item has been removed */
...
/* this creates the functionality of removing a todo item from the arry */
function remove() {
